...
os.system('color 0A')
print("Developer         :   Inacio Silva")
print("Create Date       :   2023-30-11")
#print('Project          :   DDOS-Attack')
print('Purpose           :   A simple DAILOR-Attack tool to test your network security')
...
print("Thank you for using the DAILOR (DAILOR-ATTACK-TOOL).")
